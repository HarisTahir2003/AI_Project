# %% [markdown]
# 
# # <center> <strong> **Robot Path Prediciton - Artificial Intelligence Project** </strong> </center>
# # <center> <strong> Haris Tahir Rana </strong> </center> 
# # <center> <strong> Usman Shafi </strong> </center>

# %% [markdown]
# ### **Problem Description**
# 
# In this project, we will be solving a problem where micro robots are tasked with navigating within a wooden box environment which has obstacles. Our objective is to predict the trajectory of the robot over a specified duration based on historical video data.
# 
# ### **Time Series and Lookback**
# 
# The data we have is a $\color{orange}{\text{time-series}}$. You will come across this data type very often in the field of Artificial Intelligence, since it forms the basis for many AI-based tasks. Let us learn some concepts regarding that. <br/>
# A time series dataset is a collection of data points (or observations) recorded at successive, equally spaced intervals of time, with the intention of analyzing patterns/trends, and behavior of a feature over time.
...
# ### **Objective**
# 
# Our goal is to forecast the positions of the robot using two machine learning algorithms:
# <ol>
# <li> K-Nearest Neighbours (KNN) </li>
# <li> Regression Trees (decision trees that can take continuous values instead of class labels) </li>
# </ol>

# %% [markdown]
# # <center> **Part 1A: KNN from Scratch** </center>
# 
# We will not be using the scikit-learn, or any other machine learning toolkit for this Part 1A. 
# However, we can use numpy, matplotlib, seaborn, and other standard Python libraries for this part. 
# 
# ### 1) Imports
...
# 
# Get the training and testing data `(trainX and testX)` (a function is given below to preprocess the datasets). Further, think about how you would form the predictions array `(trainY and testY)` using a lookback of 1.
...
# %% [markdown]
# 
# ### 3) Implement K-Nearest Neighbors (KNN) from Scratch
# 
...
#   * For values of k where a tie occurs, you will need to break the tie by backing off to a (k - 1) value. In case the tie persists, you will need to keep descreasing k till you get a clear winner.
...
# 
# *  Plot a line graph to evaluate your model's performance (using RMSE) across a reasonable range of K values `i.e., 2, 4, 6, 8, 10`, and explain the trend in your graph. Be sure to also identify the optimal k value and add reasoning for your choice. <br/>
# 
# * Note that our model predicts both x and y coordinates at once. Thus, the RMSE needs to account for that. 
# 
# $$
...
# %% [markdown]
# ### 5) Visualization of Actual and Predicted Path
# 
...
# 
# * Which KNN model from the above ones should you choose and why? 
# 
...
# %% [markdown]
# # <center> <strong> Part 1B: KNN using scikit-learn </strong> </center>
# 
# In this part, we will implement KNN using scikit-learn (so we can independently check how well our KNN model performs compared to the state-of-the-art).
# 
# - We will repeat the same process that we did in Part1A for plotting the actual and predicted paths. We wil use the same time interval from the testing data as before.
# 
